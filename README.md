...
- **可视化模板配置**：所有排版参数均可通过界面调整（字体、字号、行距、缩进、三线表、页眉页脚等）
...
从 [Releases](https://github.com/Fsrgrg/MDCraft/releases) 下载最新版的 `HPU论文排版工具.exe`，双击运行。
